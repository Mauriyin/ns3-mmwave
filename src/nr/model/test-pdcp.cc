...
void NrTestPdcp::DoDispose()
{
	NS_LOG_FUNCTION(this);
	delete m_rlcSapUser;
}

void NrTestPdcp::SetNrRlcSapProvider(NrRlcSapProvider *s)
{
	m_rlcSapProvider = s;
}
...
void NrTestPdcp::DoReceivePdcpPdu(Ptr<Packet> p)
{
...
void NrTestPdcp::Start()
{
	NS_LOG_FUNCTION(this);
}

void NrTestPdcp::SendData(Time time, std::string dataToSend)
{
